...
from scraper.scrapers.sainsburys import scrape_category, create_driver
...
def load_hierarchy(path="scraper/scrapers/category_hierarchy.json"):
    with open(path) as f:
        return json.load(f)
    ...
    for attempt in range(5):
        try:
            ...
            if attempt < 4:
                ...
                raise
    time.sleep(5)
    from scraper.scrapers.sainsburys import accept_cookies
